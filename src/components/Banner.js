  ...
  render() {
    return (
      <div className="card banner-card">
          <img src="https://images.hindustantimes.com/img/2022/04/01/550x309/RRR-Movie-Review_1648825470847_1648825479894.jpg" className="card-img-top banner-img" alt="..."></img>
